...
class RowOptions {
public:
    UILO_THEMED(RowOptions)

    /*
        inheritFrom(const RowOptions& prototype):
        - Params:   const RowOptions& prototype
        - Returns:  void
    ...
    */
    void inheritFrom(const RowOptions& prototype) {
    ...
    RowOptions& setOuterPadding(float px)   { m_outerPadding.set(px); return *this; }
    RowOptions& clearOuterPadding()         { m_outerPadding.clear(); return *this; }
    ...
    RowOptions& setInnerPadding(float px)   { m_innerPadding.set(px); return *this; }
    RowOptions& clearInnerPadding()         { m_innerPadding.clear(); return *this; }
    ...
    RowOptions& setColorRole(const std::string& r)    { m_colorRole.set(r); return *this; }
    RowOptions& setGradient(const Gradient& g)        { m_gradient = g; return *this; }
    RowOptions& setGradientRole(const std::string& r) { m_gradientRole.set(r); return *this; }
    RowOptions& setRounding(float r)                  { m_rounding.set(r); return *this; }
    ...
    RowOptions& setOutlineColorRole(const std::string& r) { m_outlineColorRole.set(r); return *this; }
    RowOptions& setOutlineThickness(float px)             { m_outlineThickness.set(px); return *this; }
    ...
    RowOptions& setSubDivisionColorRole(const std::string& r) { m_subDivColorRole.set(r); return *this; }
    ...
    RowOptions& setSubDivisionStripeColorRole(const std::string& r) { m_subDivStripeColorRole.set(r); return *this; }
...
public:
    void applyTheme(const Theme& theme) override {
        m_options.inheritFrom(theme.cascade<RowOptions>(m_options.getThemeRole()));
