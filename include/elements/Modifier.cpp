...
Modifier& Modifier::setWidth(Dimension dim)               { m_width = dim; return *this; }
Modifier& Modifier::setHeight(Dimension dim)              { m_height = dim; return *this; }
...
Modifier& Modifier::setOnHover(FuncPtr hover, float delay) { m_onHover = hover; m_hoverDelay = delay; return *this; }
